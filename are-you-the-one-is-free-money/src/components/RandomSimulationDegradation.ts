...
import { randomData } from "../data/aytoData";

@customElement('o-random-simulation-degradation')
export class RandomSimulationDegradation extends LitElement {
  private readonly lines: LineData[] = [];

  constructor() {
    super();
    
    for (const seriesValues of randomData) {
      const points = [];
